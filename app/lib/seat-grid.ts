...
export type LaneSpec = {
  ...
  rowGaps?: number[]
  group: LaneGroup
  isRoomBooking?: boolean          // true = entire room booked as a single unit (no seat grid)
  requiresApproval?: boolean       // true = booking requires admin approval
}
...
export const LANES: LaneSpec[] = [
  ...
  },
  {
    ...
    subtitle: '12-person conference room · Book entire room',
    icon: '🏛️',
  ...
  /* ── Meeting rooms ── */
  {
    id: 'mtg4_1',
    prefix: 'M4A',
    title: '4 PAX Meeting Room - 1 (DRS)',
    subtitle: '4-person meeting room · Book entire room',
    icon: '🤝',
  ...
  },
  {
    id: 'mtg4_2',
    prefix: 'M4B',
    title: '4 PAX Meeting Room - 2 (VAR)',
    subtitle: '4-person meeting room · Book entire room',
    icon: '🤝',
  ...
  },
  {
    id: 'mtg4_3',
    prefix: 'M4C',
    title: '4 PAX Meeting Room - 3',
    subtitle: '4-person meeting room · Book entire room',
    icon: '🤝',
    sectionId: 'meeting-4pax-3',
    roomId: 18,
    cols: 1,
    colsRows: [1],
    readFromBottom: false,
  ...
  /* ── Phone booths ── */
  {
    id: 'booth2_1',
    prefix: 'B2A',
    title: '2 Seater - Face Off 1',
    subtitle: '2-seater face-off room · Book entire room',
    icon: '🪑',
